...
public struct DarkTheme: SourceCodeTheme {
    public var lineNumbersStyle: LineNumbersStyle? = LineNumbersStyle(font: SwiftyCamp.codeFont, textColor: Color.lightGray)
    ...
    public let font = SwiftyCamp.codeFont

    public func globalAttributes() -> [NSAttributedString.Key: Any] {
        return [.font: SwiftyCamp.codeFont, .foregroundColor: UIColor.white]
    }
