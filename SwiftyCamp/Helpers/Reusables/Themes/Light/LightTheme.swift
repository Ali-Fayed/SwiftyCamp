...
public struct LightTheme: SourceCodeTheme {
    public var lineNumbersStyle: LineNumbersStyle? = LineNumbersStyle(font: SwiftyCamp.codeFont, textColor: Color.darkGray)
    ...
    public func globalAttributes() -> [NSAttributedString.Key: Any] {
        return [.font: SwiftyCamp.codeFont, .foregroundColor: UIColor.black]
    }
